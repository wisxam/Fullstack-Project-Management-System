...
const TaskCard = ({ task, canDelete }: Props) => {
  ...
  return (
    <div className="relative mb-3 flex flex-col rounded-md bg-slate-100 p-4 shadow-md dark:bg-stroke-dark dark:text-white md:flex-row md:justify-between">
      {/* Left side content */}
